...
export function Title({ message }: { message: string }) {
  return (
    <main id="home" className="flex px-5 md:px-0 items-center justify-center pt-16 pb-4 bg-[#FFF6EA] text-black">
      <div className="flex-1 flex flex-col items-center gap-10 min-h-0">
        <div className="flex flex-row items-center gap-8 relative">
          ...
          <div className="relative">
            ...
            <h1 className="text-[#587792] font-bold md:text-7xl text-4xl relative z-10">Sage Study</h1>
          </div>
        </div>
